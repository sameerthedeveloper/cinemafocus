...
const AddPressRelease = () => {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <Link to="/admin/press-releases" className="inline-flex items-center text-muted-foreground hover:text-foreground mb-6">
        <ArrowLeft size={18} className="mr-2" />
        Back to Press Releases
      </Link>
      
      <h1 className="text-3xl font-bold mb-8">Add New Press Release</h1>
